...
{
    [DbContext(typeof(FeatureRequestDbContext))]
    partial class FeatureRequestDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FeatureRequest.Entities.FeatureRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FeatureRequest.Entities.FeatureRequestComment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppFeatureRequestComments", (string)null);
                });

            modelBuilder.Entity("FeatureRequest.Entities.FeatureRequestVote", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("CreatorId", "FeatureRequestId")
                        .IsUnique();

                    b.ToTable("AppFeatureRequestVotes", (string)null);
                });
            ...
            modelBuilder.Entity("FeatureRequest.Entities.FeatureRequestComment", b =>
                {
                    b.HasOne("FeatureRequest.Entities.FeatureRequest", null)
                        .WithMany("Comments")
